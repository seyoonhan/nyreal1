...
public class GameServerSessionCacheConnectionManager extends RedisConnectionPool implements RedisConnectionManager {

    @Value("${game.server.session.redis.host.address}")
    private String redisAddress;

    @Value("${game.server.session.redis.host.port}")
    private int port;

    @Value("${game.server.session.redis.connection.timeout}")
